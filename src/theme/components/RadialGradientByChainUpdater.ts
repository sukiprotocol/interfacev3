    ...
    switch (chainId) {
      ...
      case SupportedChainId.ARBITRUM_GOERLI: {
        ...
        const arbitrumLightGradient =
          'radial-gradient(100% 100% at 50% 0%, rgba(205, 232, 251, 0.7) 0%, rgba(252, 243, 249, 0.6536) 55%, rgba(255, 255, 255, 0) 100%), #FFFFFF'
        const arbitrumDarkGradient =
          'radial-gradient(100% 100% at 50% 0%, rgba(10, 41, 75, 0.7) 0%, rgba(34, 30, 48, 0.6536) 55%, rgba(31, 33, 40, 0) 100%), #0A0C11'
      ...
      case SupportedChainId.OPTIMISM_GOERLI: {
        ...
        const optimismLightGradient =
          'radial-gradient(100% 100% at 50% 0%, rgba(255, 251, 242, 0.8) 0%, rgba(255, 244, 249, 0.6958) 55%, rgba(255, 255, 255, 0) 100%), #FFFFFF'
      ...
      case SupportedChainId.POLYGON_MUMBAI: {
        ...
        const polygonLightGradient =
          'radial-gradient(100% 100% at 50% 0%, rgba(130, 71, 229, 0.2) 0%, rgba(200, 168, 255, 0.05) 55%, rgba(0, 0, 0, 0) 100%), #FFFFFF'
      ...
      case SupportedChainId.CELO_ALFAJORES: {
        ...
        const celoLightGradient =
          'radial-gradient(100% 100% at 50% 0%, rgba(186, 228, 210, 0.7) 0%, rgba(252, 243, 249, 0.6536) 55%, rgba(255, 255, 255, 0) 100%), #FFFFFF'
        const celoDarkGradient =
          'radial-gradient(100% 100% at 50% 0%, rgba(20, 49, 37, 0.29) 0%, rgba(12, 31, 23, 0.6536) 55%, rgba(31, 33, 40, 0) 100%, rgba(31, 33, 40, 0) 100%), #0A0C11'
      ...
      default: {
        ...
        const defaultLightGradient =
          'radial-gradient(100% 100% at 50% 0%, rgba(25, 179, 128, 0.15) 0%, rgba(52, 200, 157, 0.1) 50%, rgba(55, 212, 164, 0) 100%), #FFFFFF'
        const defaultDarkGradient =
          'radial-gradient(100% 100% at 50% 0%, rgba(0, 156, 109, 0.2) 0%, rgba(141, 255, 221, 0.05) 55%, rgba(0, 0, 0, 0) 100%), #0A0C11'
